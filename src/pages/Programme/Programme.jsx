...
import { translateProgramme } from '../../utils/programmeTranslations';
...
const Programme = () => {
  ...
  const programme = useMemo(() => {
    ...
    return translateProgramme(programmeRaw, t, i18n);
  }, [t, i18n]);
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                >
                  ...
                  <div>
                    <p className="text-sm text-gray-500 mb-1">{t('programme.emailLabel')}</p>
                ...
                <div className="space-y-3">
                  {CONTACT_INFO.phones.map((phone, index) => (
                    ...
                    >
                      ...
                      <div>
                        <p className="text-sm text-gray-500 mb-1">{t('programme.phoneLabel')}</p>
